...
## 🎓 Education
I hold a degree in Bachelor of engineering in Electronics and Communication from KKWIEER, where my journey ignited a passion for solving problems involving programming languages and electronics.

---

## 💻 Experience
My journey into the tech world began with Wipro Pune as an Administrator
• Provided Level 1 technical support for clients, handling issues related to user access, Active Directory, and ServiceNow incidents
• Collaborated with senior engineers to resolve server and network-related issues.
• Solved various database and Programming issues using PYTHON, C/C++ and AI Prompt 
---
